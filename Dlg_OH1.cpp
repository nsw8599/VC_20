...
LRESULT CDlg_OH1::OnXMReceiveRealOH0(WPARAM wParam, LPARAM lParam)
{
	...
	if (strcmp(pRealPacket->szTrCode, "OH0") == 0)
	{
		...
		m_ctrlOutBlock.SetItemText(nRow++, nColumn, GetDispData(pOutBlock->offerho1, sizeof(pOutBlock->offerho1), DATA_TYPE_FLOAT,2.2));    // 매도호가1
		m_ctrlOutBlock.SetItemText(nRow++, nColumn, GetDispData(pOutBlock->bidho1, sizeof(pOutBlock->bidho1), DATA_TYPE_FLOAT, 2.2));    // 매수호가1
		...
		m_ctrlOutBlock.SetItemText(nRow++, nColumn, GetDispData(pOutBlock->offerho2, sizeof(pOutBlock->offerho2), DATA_TYPE_FLOAT, 2.2));    // 매도호가2
		m_ctrlOutBlock.SetItemText(nRow++, nColumn, GetDispData(pOutBlock->bidho2, sizeof(pOutBlock->bidho2), DATA_TYPE_FLOAT, 2.2));    // 매수호가2
		...
		m_ctrlOutBlock.SetItemText(nRow++, nColumn, GetDispData(pOutBlock->offerho3, sizeof(pOutBlock->offerho3), DATA_TYPE_FLOAT, 2.2));    // 매도호가3
		m_ctrlOutBlock.SetItemText(nRow++, nColumn, GetDispData(pOutBlock->bidho3, sizeof(pOutBlock->bidho3), DATA_TYPE_FLOAT, 2.2));    // 매수호가3
		...
		m_ctrlOutBlock.SetItemText(nRow++, nColumn, GetDispData(pOutBlock->offerho4, sizeof(pOutBlock->offerho4), DATA_TYPE_FLOAT, 2.2));    // 매도호가4
		m_ctrlOutBlock.SetItemText(nRow++, nColumn, GetDispData(pOutBlock->bidho4, sizeof(pOutBlock->bidho4), DATA_TYPE_FLOAT, 2.2));    // 매수호가4
		...
		m_ctrlOutBlock.SetItemText(nRow++, nColumn, GetDispData(pOutBlock->offerho5, sizeof(pOutBlock->offerho5), DATA_TYPE_FLOAT, 2.2));    // 매도호가5
		m_ctrlOutBlock.SetItemText(nRow++, nColumn, GetDispData(pOutBlock->bidho5, sizeof(pOutBlock->bidho5), DATA_TYPE_FLOAT, 2.2));    // 매수호가5
