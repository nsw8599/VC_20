...
LRESULT CDlg_CSPAQ02200::OnXMReceiveData( WPARAM wParam, LPARAM lParam )
{
	...
	if( wParam == REQUEST_DATA )
	{
		...
		typedef struct
		{
			CSPAQ02200OutBlock1	outBlock1;
			CSPAQ02200OutBlock2	outBlock2;
		} CSPAQ02200AllOutBlock, *LPCSPAQ02200AllOutBlock;

		LPCSPAQ02200AllOutBlock pAllOutBlock = (LPCSPAQ02200AllOutBlock)pRpData->lpData;

		// 받은 데이터 크기가 Block 크기보다 작다면 처리하지 않는다.
		if( pRpData->nDataLength >= sizeof( CSPAQ02200OutBlock1 ) )
		{
			int nCol = 0;
		...
		if( pRpData->nDataLength >= sizeof( CSPAQ02200OutBlock1 ) + sizeof( CSPAQ02200OutBlock2 ) )
		{
			int nCol = 0;
