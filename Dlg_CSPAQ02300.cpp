...
// 현물정상주문(CSPAQ02300) ( base21=SONAT000,headtype=B )
	CSPAQ02300InBlock1	pckInBlock;

	TCHAR			szTrNo[]		= "CSPAQ02300";
...
LRESULT CDlg_CSPAQ02300::OnXMReceiveData( WPARAM wParam, LPARAM lParam )
{
	...
	if( wParam == REQUEST_DATA )
	{
		...
		} CSPAQ02300AllOutBlock, *LPCSPAQ02300AllOutBlock;

		LPRECV_PACKET			pRpData		 = (LPRECV_PACKET)lParam;
		LPCSPAQ02300AllOutBlock pAllOutBlock = (LPCSPAQ02300AllOutBlock)pRpData->lpData;
		...
		nDataLength -= sizeof( CSPAQ02300OutBlock1 );
		if( nDataLength < 0 )
		{
			return 0L;
		}
		...
		//------------------------------------------------
		// OutBlock2
		nDataLength -= sizeof( CSPAQ02300OutBlock2 );
		if( nDataLength < 0 )
		{
			return 0L;
		}
		...
		// Data
		nDataLength -= sizeof( CSPAQ02300OutBlock3 ) * nCount;
		if( nDataLength < 0 )
		{
			return 0L;
		}
