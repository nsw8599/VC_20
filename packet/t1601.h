...
{
    char    gubun1              [   1];    char    _gubun1              ;    // [string,    1] 주식금액수량구분1               StartPos 0, Length 1
    char    gubun2              [   1];    char    _gubun2              ;    // [string,    1] 옵션금액수량구분2               StartPos 2, Length 1
    char    gubun3              [   1];    char    _gubun3              ;    // [string,    1] 금액단위                        StartPos 4, Length 1
    char    gubun4              [   1];    char    _gubun4              ;    // [string,    1] 선물금액수량구분4               StartPos 6, Length 1
    char    exchgubun           [   1];    char    _exchgubun           ;    // [string,    1] 거래소구분코드                  StartPos 8, Length 1
