...
typedef struct _t1621InBlock
{
    ...
    char    nmin                [   2];    char    _nmin                ;    // [long  ,    2] N분                             StartPos 4, Length 2
    char    cnt                 [   3];    char    _cnt                 ;    // [long  ,    3] 조회건수                        StartPos 7, Length 3
    char    bgubun              [   1];    char    _bgubun              ;    // [string,    1] 전일분                          StartPos 11, Length 1
    char    exchgubun           [   1];    char    _exchgubun           ;    // [string,    1] 거래소구분코드                  StartPos 13, Length 1
...
typedef struct _t1621OutBlock
{
    ...
    char    ex_upcode           [   4];    char    _ex_upcode           ;    // [string,    4] 거래소별업종코드                StartPos 90, Length 4
...
typedef struct _t1621OutBlock1
{
    ...
    char    upclose             [   6];    char    _upclose             ;    // [double,  6.2] 기준지수                        StartPos 295, Length 6
