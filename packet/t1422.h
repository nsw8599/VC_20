...
typedef struct _t1422InBlock
{
    ...
    char    jshex               [   1];    char    _jshex               ;    // [string,    1] 전일상하한제외(C:제외)          StartPos 57, Length 1
    char    exchgubun           [   1];    char    _exchgubun           ;    // [string,    1] 거래소구분코드                  StartPos 59, Length 1
...
typedef struct _t1422OutBlock1
{
    ...
    char    diff_vol            [  10];    char    _diff_vol            ;    // [double, 10.2] 거래증가율                      StartPos 61, Length 10
    ...
    char    ex_shcode           [  10];    char    _ex_shcode           ;    // [string,   10] 거래소별단축코드                StartPos 134, Length 10
