...
typedef struct _t1308InBlock
{
    ...
    char    exchgubun           [   1];    char    _exchgubun           ;    // [string,    1] 거래소구분코드                  StartPos 20, Length 1
...
{
    char    ex_shcode           [  10];    char    _ex_shcode           ;    // [string,   10] 거래소별단축코드                StartPos 0, Length 10
...
typedef struct _t1308OutBlock1
{
    ...
    char    chdegvol            [   8];    char    _chdegvol            ;    // [double,  8.2] 체결강도(거래량)                StartPos 45, Length 8
    char    chdegcnt            [   8];    char    _chdegcnt            ;    // [double,  8.2] 체결강도(건수)                  StartPos 54, Length 8
