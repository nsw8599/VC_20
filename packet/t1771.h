...
typedef struct _t1771InBlock
{
    ...
    char    exchgubun           [   1];    char    _exchgubun           ;    // [string,    1] 거래소구분                      StartPos 40, Length 1
...
typedef struct _t1771OutBlock2
{
    ...
    char    exchname            [   3];    char    _exchname            ;    // [string,    3] 거래소명                        StartPos 166, Length 3
    char    ex_shcode           [  10];    char    _ex_shcode           ;    // [string,   10] 거래소별단축코드                StartPos 170, Length 10
