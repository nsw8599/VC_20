...
typedef struct _t1486InBlock
{
    ...
    char    cnt                 [   4];    char    _cnt                 ;    // [long  ,    4] 조회건수                        StartPos 18, Length 4
    char    exchgubun           [   1];    char    _exchgubun           ;    // [string,    1] 거래소구분코드                  StartPos 23, Length 1
...
typedef struct _t1486OutBlock
{
    ...
    char    ex_shcode           [  10];    char    _ex_shcode           ;    // [string,   10] 거래소별단축코드                StartPos 11, Length 10
...
typedef struct _t1486OutBlock1
{
    ...
    char    exchname            [   3];    char    _exchname            ;    // [string,    3] 거래소명                        StartPos 93, Length 3
