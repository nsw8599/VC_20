...
typedef struct _CEXAT11100InBlock1
{
    ...
    char    ErxPrcCndiTpCode    [   1];    // [string,    1] 유렉스가격조건구분코드          StartPos 41, Length 1
    char    OrdPrc              [  15];    // [double, 15.2] 주문가격                        StartPos 42, Length 15
    char    OrdQty              [  16];    // [long  ,   16] 주문수량                        StartPos 57, Length 16
