...
typedef struct _B7__OutBlock
{
    ...
    char    midprice            [   8];    char    _midprice            ;    // [long  ,    8] 중간가격                        StartPos 598, Length 8
    char    offermidsumrem      [   9];    char    _offermidsumrem      ;    // [long  ,    9] 매도중간가잔량합계수량          StartPos 607, Length 9
    char    bidmidsumrem        [   9];    char    _bidmidsumrem        ;    // [long  ,    9] 매수중간가잔량합계수량          StartPos 617, Length 9
