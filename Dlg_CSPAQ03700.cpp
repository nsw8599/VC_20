...
{
	//-----------------------------------------------------------
	CSPAQ03700InBlock1	pckInBlock;

	TCHAR			szTrNo[]		= "CSPAQ03700";
	char			szNextKey[]		= "";
...
LRESULT CDlg_CSPAQ03700::OnXMReceiveData( WPARAM wParam, LPARAM lParam )
{
	...
	if( wParam == REQUEST_DATA )
	{
		...
		} CSPAQ03700AllOutBlock, *LPCSPAQ03700AllOutBlock;

		LPRECV_PACKET			pRpData		 = (LPRECV_PACKET)lParam;
		LPCSPAQ03700AllOutBlock pAllOutBlock = (LPCSPAQ03700AllOutBlock)pRpData->lpData;
		...
		//------------------------------------------------
		// OutBlock2
		nDataLength -= sizeof( CSPAQ03700OutBlock2 );
		if( nDataLength < 0 )
		{
			return 0L;
		}
		...
		// Data
		nDataLength -= sizeof( CSPAQ03700OutBlock3 ) * nCount;
		if( nDataLength < 0 )
		{
			return 0L;
		}
