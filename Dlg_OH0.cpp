...
IMPLEMENT_DYNCREATE(CDlg_OH0, CDialog)

CDlg_OH0::CDlg_OH0(CWnd* pParent /*=NULL*/)
	: CDialog(CDlg_OH0::IDD, pParent)
{

}


void CDlg_OH0::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(CDlg_OH0, CDialog)
	//	ON_WM_ACTIVATE()
	ON_WM_DESTROY()
...
// CDlg_OH0 message handlers


BOOL CDlg_OH0::OnInitDialog()
{
...
// 데이터를 받음
//--------------------------------------------------------------------------------------
LRESULT CDlg_OH0::OnXMReceiveRealOH0(WPARAM wParam, LPARAM lParam)
{
	...
	if (strcmp(pRealPacket->szTrCode, "OH0") == 0)
	{
		...
		m_ctrlOutBlock.SetItemText(nRow++, 1, GetDispData(pOutBlock->offerho4, sizeof(pOutBlock->offerho4), DATA_TYPE_FLOAT, 2));    // 매도호가4
		m_ctrlOutBlock.SetItemText(nRow++, 1, GetDispData(pOutBlock->bidho4, sizeof(pOutBlock->bidho4), DATA_TYPE_FLOAT, 2));    // 매수호가4
		...
		m_ctrlOutBlock.SetItemText(nRow++, 1, GetDispData(pOutBlock->offerho5, sizeof(pOutBlock->offerho5), DATA_TYPE_FLOAT, 2));    // 매도호가5
		m_ctrlOutBlock.SetItemText(nRow++, 1, GetDispData(pOutBlock->bidho5, sizeof(pOutBlock->bidho5), DATA_TYPE_FLOAT, 2));    // 매수호가5
