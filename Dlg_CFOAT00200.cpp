...
// 현물정상주문(CFOAT00200) ( base21=SONAT000,headtype=B )
	...
	SetPacketData( pckInBlock.FnoOrdPrc          , sizeof( pckInBlock.FnoOrdPrc           ), strOrdPrc          , DATA_TYPE_DOT, 2 );    // [double, 15.2] 주문가격            
...
LRESULT CDlg_CFOAT00200::OnXMReceiveData( WPARAM wParam, LPARAM lParam )
{
	...
	if( wParam == REQUEST_DATA )
	{
		...
		m_ctrlOutBlock1.SetItemText(  0, nCol++, GetDispData( pAllOutBlock->outBlock1.FnoOrdPrc           , sizeof( pAllOutBlock->outBlock1.FnoOrdPrc            ), DATA_TYPE_DOT, 2 ) );    // [double, 15.2] 주문가격            
